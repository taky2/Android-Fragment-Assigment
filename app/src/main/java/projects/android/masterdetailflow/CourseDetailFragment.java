package projects.android.masterdetailflow;
...
import projects.android.masterdetailflow.dummy.DummyContent;
...
public class CourseDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mItem != null) {
            ((TextView) rootView.findViewById(R.id.course_detail)).setText(mItem.content);
        }
